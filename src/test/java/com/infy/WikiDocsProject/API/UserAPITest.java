...
public class UserAPITest {
    ...
    @Test
    public void testgetNameByEmail_User() throws Exception {
        this.mockMvc.perform(
                get("/UserAPI/getNameByEmail/"+users.get(0).getEmail())
                        .header("Authorization", tokens.get(users.get(0))))
                .andExpect(status().isOk());
    }
    
    @Test
    public void testgetNameByEmail_Admin() throws Exception {
        this.mockMvc.perform(
                get("/UserAPI/getNameByEmail/"+admins.get(0).getEmail())
